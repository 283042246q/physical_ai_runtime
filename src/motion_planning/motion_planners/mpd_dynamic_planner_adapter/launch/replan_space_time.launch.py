"""Launch Phase-5 space-time MPD; the resident worker is external."""
...
def generate_launch_description() -> LaunchDescription:
    default_config = PathJoinSubstitution(
        [FindPackageShare("mpd_dynamic_planner_adapter"), "config", "replan_space_time.yaml"]
    )
    arguments = [
        ...
        DeclareLaunchArgument("socket_path", default_value="/tmp/mpd-space-time-runtime.sock"),
        DeclareLaunchArgument("timing_mode", default_value="phase5_joint"),
    ...
    replanner = Node(
        ...
        executable="space_time_replan_node",
        name="mpd_space_time_replanner",
        output="screen",
        parameters=[
            LaunchConfiguration("config"),
            {
                ...
                "timing_mode": LaunchConfiguration("timing_mode"),
    ...
    safe_stop = Node(
        ...
        name="mpd_space_time_jtc_safe_stop",
        output="screen",
